...
pie = pyecharts.Pie("top"+input_actor_sum+"劳模演员",title_pos='center')
kwargs = dict(
    radius = (70,75),
    label_text_color = None,
    is_label_show = True,
...
pie.add("",movies_all_actor[:int(input_actor_sum)],movies_all_actor_boxoffice[:int(input_actor_sum)],**kwargs)
pie.render("top"+input_actor_sum+"劳模演员.html")
